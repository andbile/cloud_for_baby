...
!function (e, n) {
    ...
    var a = "fullpage-wrapper", r = "." + a, l = "fp-responsive", s = "fp-notransition", c = "fp-destroyed",
        d = "fp-enabled", f = "fp-viewing", u = "active", v = "." + u, h = "fp-completely", p = "." + h,
        g = "fp-section", m = "." + g, S = m + v, w = m + ":first", b = m + ":last", x = "fp-tableCell", y = "." + x,
        C = "fp-auto-height", T = "fp-normal-scroll", A = "fp-nav", M = "#" + A, k = "fp-tooltip", O = "." + k,
        R = "fp-show-active", z = "fp-slide", I = "." + z, L = I + v, H = "fp-slides", E = "." + H,
        B = "fp-slidesContainer", D = "." + B, P = "fp-table", Y = "fp-initial", F = "fp-slidesNav", W = "." + F,
        X = W + " a", V = "fp-controlArrow", Z = "." + V, N = "fp-prev", j = V + " " + N, q = Z + ("." + N),
        G = "fp-next", U = V + " " + G, Q = Z + ".fp-next", J = e(n), K = e(t);
    e.fn.fullpage = function (V) {
        if (e("html").hasClass(d)) kt(); else {
            var G = e("html, body"), _ = e("body"), $ = e.fn.fullpage;
            V = e.extend(!0, {
                menu: !1,
                anchors: [],
                lockAnchors: !1,
            ...
            var ee, ne, te, oe, ie = !1,
                ...
                re = "ontouchstart" in n || navigator.msMaxTouchPoints > 0 || navigator.maxTouchPoints, le = e(this),
                se = J.height(), ce = !1, de = !0, fe = !0, ue = [], ve = {m: {up: !0, down: !0, left: !0, right: !0}};
            ve.k = e.extend(!0, {}, ve.m);
            var he, pe, ge, me, Se, we, be, xe, ye = pt(), Ce = {
            ...
            kt(), e.extend(e.easing, {
            ...
            }, $.landscapeScroll = Un, $.shared = {afterRenderActions: sn}, an("continuousHorizontal"), an("scrollHorizontally"), an("resetSliders"), an("interlockedSlides"), an("responsiveSlides"), an("fadingEffect"), an("dragAndMove"), an("offsetSections"), an("scrollOverflowReset"), an("parallax"), yt("dragAndMove") && $.dragAndMove.init(), function () {
                ...
                V.scrollBar = V.scrollBar || V.hybrid, o = le.find(V.sectionSelector), V.anchors.length || (V.anchors = o.filter("[data-anchor]").map(function () {
                    ...
                    var t, o, i, a, l = e(this), s = l.find(I), c = s.length;
                    ...
                    for (var t = 0; t < e(m).length; t++) {
                        ...
                        var i = '<li><a href="#' + o + '"><span></span></a>', a = V.navigationTooltips[t];
            ...
            var Oe, Re = !1, ze = 0, Ie = 0, Le = 0, He = 0, Ee = 0;
            ...
            var Be, De, Pe, Ye = (new Date).getTime(), Fe = !1, We = 0, Xe = 0, Ve = se
        }
        ...
        function tn(n) {
            if (!le.hasClass(c)) {
                ce = !0, se = J.height(), e(m).each(function () {
                    var n = e(this).find(E), t = e(this).find(I);
        ...
        function dn() {
            ...
            if (le.trigger("onScroll"), (!V.autoScrolling || V.scrollBar || yt("dragAndMove")) && !At()) {
                var r = yt("dragAndMove") ? o.abs($.dragAndMove.getCurrentScroll()) : J.scrollTop(),
                    l = (a = (i = r) > ze ? "down" : "up", ze = i, We = i, 0), s = r + J.height() / 2,
                    c = (yt("dragAndMove") ? $.dragAndMove.getDocumentHeight() : _.height() - J.height()) === r,
                    d = t.querySelectorAll(m);
                if (c) l = d.length - 1; else if (r) for (var f = 0; f < d.length; ++f) {
                    d[f].offsetTop <= s && (l = f)
                } else l = 0;
                if (!(n = e(d).eq(l)).hasClass(u)) {
                    Re = !0;
                    var v, h, p = e(S), g = p.index(m) + 1, w = ot(n), b = n.data("anchor"), x = n.index(m) + 1,
                        y = n.find(L);
        ...
        function un(n) {
            if (ve.m[n]) {
                ...
                if ($.scrollHorizontally && (t = $.scrollHorizontally.getScrollSection(n, t)), V.scrollOverflow) {
                    var o = V.scrollOverflowHandler.scrollable(e(S)), i = "down" === n ? "bottom" : "top";
                    if (o.length > 0) {
        ...
        function hn(n) {
            var t = n.originalEvent, i = e(t.target).closest(m);
            if (pn(t)) {
        ...
        function Sn(t) {
            ...
            if (V.autoScrolling && !te && !a) {
                var r = (t = t || n.event).wheelDelta || -t.deltaY || -t.detail, l = o.max(-1, o.min(1, r)),
        ...
        function xn(e) {
            var n = e.position(), t = n.top,
                ...
                i = t - se + e.outerHeight(), a = V.bigSectionsDestination;
        ...
        function yn(n, t, i) {
            if (void 0 !== n && n.length) {
                ...
                if (!(s.activeSection.is(n) && !ce || V.scrollBar && J.scrollTop() === s.dtop && !n.hasClass(C))) {
                    ...
                    Ct("parallax", "apply", s), V.autoScrolling && V.continuousVertical && void 0 !== s.isMovementUp && (!s.isMovementUp && "up" == s.yMovement || s.isMovementUp && "down" == s.yMovement) && (s = function (n) {
                    ...
                    }(s)), yt("scrollOverflowReset") && $.scrollOverflowReset.setPrevious(s.activeSection), s.localIsResizing || On(s.activeSection), V.scrollOverflow && V.scrollOverflowHandler.beforeLeave(), n.addClass(u).siblings().removeClass(u), An(n), V.scrollOverflow && V.scrollOverflowHandler.onLeave(), fe = !1, ft(l, a, s.anchorLink, s.sectionIndex), function (n) {
                        if (V.css3 && V.autoScrolling && !V.scrollBar) {
                            ...
                            var i = function (e) {
                                var n = {};
                                V.autoScrolling && !V.scrollBar ? (n.options = {top: -e.dtop}, n.element = r) : (n.options = {scrollTop: e.dtop}, n.element = "html, body");
                                return n
                            }(n);
        ...
        function In(e) {
            var n = function () {
                    ...
                    return ""
                }(), o = ["MTM0bG9jYWxob3N0MjM0", "MTM0MC4xMjM0", "MTM0anNoZWxsLm5ldDIzNA==", "UDdDQU5ZNlNN"], i = zn(o[0]),
                a = zn(o[1]), r = zn(o[2]), l = zn(o[3]), s = [i, a, r].indexOf(n) < 0 && 0 !== n.length,
        ...
        function Bn() {
            var e = Pn(), n = e.section, t = e.slide;
            n && (V.animateAnchor ? ct(n, t) : _e(n, t))
        }

        function Dn() {
            if (!Re && !V.lockAnchors) {
                var e = Pn(), n = e.section, t = e.slide, o = void 0 === ee, i = void 0 === ee && void 0 === t && !ie;
        ...
        function Pn() {
            ...
            if (o.length) {
                var i = o.replace("#", "").split("/"), a = o.indexOf("#/") > -1;
        ...
        function Yn(n) {
            ...
            if (9 === o) !function (n) {
                var t = n.shiftKey, o = e(":focus"), i = e(S), a = i.find(L),
            ...
            }(n); else if (!t.is("textarea") && !t.is("input") && !t.is("select") && "true" !== t.attr("contentEditable") && "" !== t.attr("contentEditable") && V.keyboardScrolling && V.autoScrolling) {
        ...
        function Kn(e, n, t) {
            ...
            } else e.animate({scrollLeft: o.round(i.left)}, V.scrollingSpeed, V.easing, function () {
                t && Jn(n)
            })
        }
        ...
        function $n() {
            var e = V.responsive || V.responsiveWidth, n = V.responsiveHeight, t = e && J.outerWidth() < e,
                o = n && J.height() < n;
        ...
        function ct(e, n) {
            ...
            if (t.length) {
                var o, i, a,
                    r = (o = n, (a = (i = t).find(I + '[data-anchor="' + o + '"]')).length || (o = void 0 !== o ? o : 0, a = i.find(I).eq(o)), a);
        ...
        function ut(e) {
            if (V.recordHistory) location.hash = e; else if (ae || re) n.history.replaceState(i, i, "#" + e); else {
        ...
        function ht() {
            var n = e(S), t = n.find(L), o = vt(n), i = vt(t), a = String(o);
        ...
        function pt() {
            return n.PointerEvent ? {down: "pointerdown", move: "pointermove"} : {
                down: "MSPointerDown",
                move: "MSPointerMove"
            }
        }
